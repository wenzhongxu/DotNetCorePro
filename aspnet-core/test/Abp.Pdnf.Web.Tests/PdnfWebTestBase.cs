...
{
    public abstract class PdnfWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PdnfWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PdnfWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PdnfDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PdnfDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PdnfDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PdnfDbContext, Task<T>> func)
        {
            T result;
