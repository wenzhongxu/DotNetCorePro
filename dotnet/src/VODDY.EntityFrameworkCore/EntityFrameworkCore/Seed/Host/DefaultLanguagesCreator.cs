...
namespace VODDY.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly VODDYDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = VODDYConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(VODDYDbContext context)
        {
            _context = context;
        }
