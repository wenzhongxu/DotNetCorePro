...
{
    public abstract class VODDYWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VODDYWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VODDYWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<VODDYDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<VODDYDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VODDYDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VODDYDbContext, Task<T>> func)
        {
            T result;
